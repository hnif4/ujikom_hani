...
<head>
    ...
    <title>Gallery SMKN 4 Bogor</title>
...
<body class="font-sans antialiased bg-gray-50">
    <!-- Navbar -->
    <nav class="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md">
                    ...
                    <form action="{{ route('search') }}" method="GET" class="w-96">
                        <div class="relative">
                            <input type="text" 
                                   ...
                                   class="w-full bg-gray-800/50 text-white placeholder-gray-400 rounded-lg pl-4 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                            <button type="submit" 
    ...
    <div class="md:hidden" x-data="{ open: false }" @toggle-menu.window="open = !open" x-cloak>
        ...
        <div x-show="open" 
             class="fixed top-0 right-0 z-50 w-64 h-full bg-white shadow-lg transform transition-transform duration-300"
